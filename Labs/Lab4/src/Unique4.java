...
public class Unique4
{
   public static void main(String[] args)
   {
      ...
      System.out.print("How many numbers do you want to put in an array?: ");
      int user = input.nextInt();
      
      int[] numbers = new int[user]; // array that has inputed amount
      ...
      //if the numbers in the array are equal to the length, prints that it's full
