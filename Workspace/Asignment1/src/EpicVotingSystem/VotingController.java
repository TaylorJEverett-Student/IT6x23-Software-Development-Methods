...
public class VotingController {
	...
	public void loadCandidateData() {
		try {
			candidates.clear();//this is here to refresh changes made my admin panel
	...
	// =================================================================
	// loads staff data from file.
	public void loadStaffData() {
		try {
			staffs.clear();//this is here to refresh changes made my admin panel
			String fileName = "staff.txt";

			File theFile = new File(fileName);
			//reads from filename  to be put into a string 
			BufferedReader reader = new BufferedReader(new FileReader(theFile));

			String staffData;
			String[] staffDetails;

			while ((staffData = reader.readLine()) != null) {//loop loads data from file so it can be used
	...
	// =================================================================
	//This method returns a Candidate object if found in the candidates ArrayList matching codes
	...
	public void loadAdminData() {
		try {
			admins.clear();//this is here to refresh changes made my admin panel
			...
			while ((adminData = reader.readLine()) != null) {//loop loads data from file so it can be used
	...
	// returns the collection of admin
